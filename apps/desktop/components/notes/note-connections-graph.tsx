...
export function NoteConnectionsGraph({ noteId, backlinks, forwardLinks }: NoteConnectionsGraphProps) {
    ...
    return (
        <div className="flex flex-col gap-3 shrink-0 py-3 px-2.5 mb-2 border border-border/60 bg-accent/5 rounded-xl min-w-0">
            <h3 className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60 px-0.5 shrink-0 flex items-center gap-1.5">
