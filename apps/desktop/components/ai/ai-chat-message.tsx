        ...
        >
            <div
                ...
                className={cn(
                    ...
                    isUser
                        ? "max-w-[85%] bg-muted-foreground/10 text-foreground border border-border/60  self-end shadow-[0_3px_10px_rgba(0,0,0,0.06)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.25)]"
