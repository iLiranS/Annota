...
export interface PlatformAdapters {
    ...
    crypto: {
        ...
        sha256HexUtf8: (data: string) => string;
        /**
         ...
         */
        aes256GcmEncrypt: (params: { key: Uint8Array; nonce: Uint8Array; plaintext: Uint8Array }) => { ciphertext: Uint8Array; authTag: Uint8Array };
        aes256GcmDecrypt: (params: { key: Uint8Array; nonce: Uint8Array; ciphertext: Uint8Array; authTag: Uint8Array }) => Uint8Array;
    };
